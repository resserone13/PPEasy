...
class MyScene (Scene):
	def setup(self):
		...
		self.shield_box = ShapeNode(ui.Path.rounded_rect(0, 0, self.size.w * 0.65, self.size.h * 0.07, 20))
		self.shield_box.position=(self.size.w/2, self.size.h * 0.69)
		self.shield_box.fill_color=btn_color
		self.shield_box.line_width=4
		self.shield_box.stroke_color=btn_border_color
		self.shield_box.shadow=btn_shadow		
		self.add_child(self.shield_box)
